...
CPU에서 연산은 ALU에서 이루어진다. ALU의 입출력을 조율하는 <b>CU(제어 장치)</b>, 연산 도중의 임시 저장소 역할을 하는 <b>레지스터(Register)</b>, 데이터 통신 체계인 버스(Bus), 병목현상을 방지하기 위한 캐시(Cache) 등 등 다른 CPU 구성 요소도 있지만, 결과물이 만들어지는 장소는 ALU이며 이 산술논리장치는 트랜지스터라는 지식적 산물이 근간을 이룬다.
...
<span style="font-size:20%"><center>삼성, LG, 샤오미, 소니, 원플러스, 비보, 샤프(& 라이카)...</center></span>

안드로이드는 ARM이 설계한 코어를 갖고 와 쓴다.

<h4>ARM Cortex-X1</h4>

![Cortex-X1_Reason](https://user-images.githubusercontent.com/96360829/185616777-6b486c40-584b-420d-93cb-1e6b1fa9d872.png)
